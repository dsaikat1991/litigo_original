    ...
    <div className="min-h-screen bg-gray-50 px-4 py-12">
      <div className="mx-auto max-w-2xl rounded-lg border border-gray-200 bg-white p-8">
        ...
        <div className="space-y-5 text-sm text-gray-700">
          <section>
            <h2 className="mb-1 font-semibold text-gray-900">Using mylitigo</h2>
            <p>
              mylitigo is a case diary tool for advocates. You&rsquo;re responsible for the accuracy of
          ...
          <section>
            ...
            <p>
              You retain ownership of everything you enter. mylitigo is a tool to help you track it — it
          ...
          <section>
            ...
            <p>You may stop using mylitigo and request deletion of your account at any time.</p>
          </section>
        </div>
      </div>
    </div>
